//
// Created by HAPPY on 2021/2/23.
//

#ifndef ACIENT_FNV1A_H
#define ACIENT_FNV1A_H
...
{
    return fnv1a32::make_hash(s, len, fnv1a32::ascii_toupper);
}
...
{
    return fnv1a64::make_hash(s, len, fnv1a64::ascii_tolower);
}
